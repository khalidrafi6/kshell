...
Many people want to learn programming but can't afford a computer. Good news for them: you can learn programming using just your mobile phone. Let’s see how:
...
- [Emacs](https://ftp.gnu.org/gnu/emacs/android)
- [Neovim](https://github.com/neovim/neovim/blob/master/INSTALL.md#android)

Both are cross-platform, so you can use the same editor everywhere. Emacs has an official Android app and is the best option for coding on Android. You can integrate it with Termux and get a powerful coding environment similar to your desktop. [Read my article](/en/install-emacs-on-android) on how to install and set it up. Compared to that, Neovim doesn't have an Android app and only usable inside [Termux](https://termux.com/). It has a learning curve but it is a very powerful editor if you can master it. You can also emulate its keybindings on Emacs which is what I do. For both editors, you can find detailed instructions on their respective websites. Feel free to ask me if you need help.
