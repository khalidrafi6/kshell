...
image = "../../assets/install-spacemacs-on-android.png"
...
4. Now, it will ask you a few questions to create `$HOME/.spacemacs` file which contains Spacemacs configuration. Firstly, it will ask you to choose keybindings:

- Vim: It is the keybindings of Vim editor. If you are coming from Vim/Neovim, this is the best choice for you. If you are new to this, know that Vim keybindings take some time to learn. But, once you have mastered it, it is very powerful. I myself use it, too. I am a former Neovim user.

- Emacs: If you are not comfortable with Vim editing style, you can choose this. 

Now, Emacs will start downloading packages.
```
