...
When you visit this website, I collect some of your data through Simple Analytics. But don't worry. This data is anonymized and cannot be used to identify you. I collect this data to gather general statistics about audience. However, if you have **Do Not Track** enabled in your browser, this data will not be collected. To know what data I (and in turn Simple Analytics) collect, read [this](https://docs.simpleanalytics.com/what-we-collect) by Simple Analytics.
