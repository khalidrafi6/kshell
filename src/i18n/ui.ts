...
export const ui = {
  en: {
    ...
    "footer.attribution": "You are free to copy any article from this blog provided you attribute it to me",
    "footer.affiliate": "",
  },
  bn: {
    ...
    "article.affiliate": "এই আর্টিকেলে অ্যাফিলিয়েট লিংক রয়েছে। অর্থাৎ, এরূপ লিংক থেকে কিছু কিনলে আপনার কোন খরচ ছাড়াই আমি কমিশন লাভ করি। কোন পণ্যের কোয়ালিটির নিশ্চয়তা আমি দেই না। তবে খারাপ পণ্য পেলে অবশ্যই আমাকে জানান। আর আমার কাজ আপনার ভাল লাগলে অনুগ্রহ করে অ্যাফিলিয়েট লিংক থেকে পণ্য ক্রয় করে আমাকে সহায়তা করুন।",
    "date.replace": "যুগ",
...
"footer.attribution": "এই ব্লগের যেকোন আর্টিকেল আপনি কপি করতে পারেন, তবে অবশ্যই লেখক হিসেবে আমার নাম উল্লেখ করতে হবে",
  },
} as const;
