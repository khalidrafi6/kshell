...
export const ui = {
  en: {
    ...
    "article.affiliate": "This article contains affiliate links. This means that if you purchase something through these links, I receive a commission at no additional cost to you. I cannot guarantee the quality of any product since I present product descriptions based on information provided by the publisher/seller. However, if you find a bad product, please do let me know. If you like my work, please consider purchasing through affiliate links to support me.",
    "date.replace": "AH",
    ...
    "footer.attribution":
      "You are free to copy and share any article from this website provided you attribute it to me with a link to the source",
  },
  bn: {
    ...
    "article.affiliate":
      "এই আর্টিকেলে অ্যাফিলিয়েট লিংক রয়েছে। অর্থাৎ, এরূপ লিংক থেকে কিছু কিনলে আপনার কোন খরচ ছাড়াই আমি কমিশন লাভ করি। কোনো পণ্যের গুণগত মানের নিশ্চয়তা আমি দিতে পারি না, কেননা পণ্যসমূহের বিবরণ আমি প্রকাশক/বিক্রেতার দেওয়া বর্ণনা অনুযায়ীই উপস্থাপন করি। তবে খারাপ পণ্য পেলে অবশ্যই আমাকে জানাবেন। আর আমার কাজ ভাল লাগলে অনুগ্রহ করে অ্যাফিলিয়েট লিংক থেকে পণ্য ক্রয় করে আমাকে সহায়তা করুন।",
    "date.replace": "যুগ",
    ...
    "footer.attribution":
      "এই ওয়েবসাইটের যেকোন আর্টিকেল আপনি শেয়ার ও কপি করতে পারেন, তবে অবশ্যই সাথে মূল আর্টিকেলের লিংক সংযুক্ত করতে হবে ও লেখক হিসেবে আমার নাম উল্লেখ করতে হবে",
  },
} as const;
