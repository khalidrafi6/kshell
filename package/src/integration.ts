...
const openGraphLocalesSchema = z.object({
  /**
  ...
  /**
   * Open Graph meta tags for the services page.
   */
  services: openGraphOptionsSchema,
});
...
export const optionsSchema = z.object({
   ...
   */
  openGraph: z.object({
    bn: openGraphLocalesSchema,
    en: openGraphLocalesSchema,
  }),
  /**
...
export default function integration(
  ...
  const globals = viteVirtualModulePluginBuilder(
    ...
    export const openGraph = {
      bn: {
      home: ${JSON.stringify(validatedOptions.openGraph.bn.home)},
      articles: ${JSON.stringify(validatedOptions.openGraph.bn.articles)},
      services: ${JSON.stringify(validatedOptions.openGraph.bn.services)},
      },
      en: {
      home: ${JSON.stringify(validatedOptions.openGraph.en.home)},
      articles: ${JSON.stringify(validatedOptions.openGraph.en.articles)},
      services: ${JSON.stringify(validatedOptions.openGraph.en.services)},
      }
    };
